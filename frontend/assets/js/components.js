                ...
                <div class="header-content">
                    ...
                    <div class="header-actions">
                        ...
                        <button class="user-avatar-btn" onclick="handleUserClick()">
                            <img src="/assets/images/avatar.svg" alt="User" class="user-avatar-img">
                        </button>
...
function handleUserClick() {
    ...
    menu.innerHTML = `
        <div class="user-dropdown-header">
            <img src="/assets/images/avatar.svg" alt="Avatar" class="dropdown-avatar">
        ...
        ${userRole === 'admin' ? `
        <button class="user-dropdown-item" onclick="window.location.href='/dashboard/'">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
